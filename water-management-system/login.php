    ...
    <div id="page-" class="col-md-4 col-md-offset-4 -align-center">
        <form class="form loginform" method="POST" action="login.php">
            <div class="login-panel panel panel-default">
                ...
                <h5 style="padding-left: 3%;">Have an Account ? <a href="login.php">Login</a> </h5>
                <?php } else{?>
                ...
                <h5 style="padding-left: 3%;">Don't Have an Account ? <a href="login.php?register=true">Register</a>
                </h5>
                <?php } ?>
            </div>
        </form>
